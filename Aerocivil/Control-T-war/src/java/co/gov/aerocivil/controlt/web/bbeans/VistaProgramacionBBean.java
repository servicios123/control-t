...
public class VistaProgramacionBBean {
    ...
    public void onDateAnularOrdinary(DateSelectEvent ev) {
        LoginBBean logbbean = (LoginBBean) JsfUtil.getManagedBean(LoginBBean.class);
        fun_anular = null;
        list_fun_anular_ord = null;
        turn_anular = null;
        list_fun_anular_ord = modificarTurnoServiceBean.getFuncionarioTurnoPorFecha(ev.getDate(), logbbean.getFuncionarioTO().getFuncionario().getDependencia().getDepId());
        //System.out.println("Entra a onDateAnular \t N. "+list_fun_anular.size());
    }
