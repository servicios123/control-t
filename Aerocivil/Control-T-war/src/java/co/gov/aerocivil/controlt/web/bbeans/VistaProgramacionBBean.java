...
public class VistaProgramacionBBean {
    ...
    private Date mes_actual,date_cambio_1,date_asignar,date_anular,date_asignar_esp;
    private Funcionario fun_cambio_1,fun_cambio_2, fun_asignar, fun_anular,fun_asignar_esp;
    private List<Funcionario> list_fun_cambio_1,list_fun_cambio_2, list_fun_asignar, list_fun_anular,list_fun_asignar_esp;
    
    private Vistaprogramacion turn_cambio_1,turn_cambio_2,turn_anular;
    private List<Vistaprogramacion> list_turn_cambio_1,list_turn_cambio_2,list_turn_anular;
