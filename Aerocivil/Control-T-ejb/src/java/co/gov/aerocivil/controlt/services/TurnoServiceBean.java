    ...
    public void corregirTipos(Date turFecha, Long proId, Long funId, Funcionario f) {
        ...
        if (turnos != null && !turnos.isEmpty()) {
            if (turnos.size() == 1) {
                ...
                t.setTurTipo(t.getTurTipo() != 3 ? 1L : 3L);
                ...
                if (t2.getTurHFin() < t1.getTurHInicio()) {
                    t2.setTurTipo(t2.getTurTipo() != 3 ? 1L : 3L);
                    t1.setTurTipo(t1.getTurTipo() != 3 ? 2L : 3L);
                } else {
                    t2.setTurTipo(t2.getTurTipo() != 3 ? 2L : 3L);
                    t1.setTurTipo(t1.getTurTipo() != 3 ? 1L : 3L);
                }
